...
const movivePoster = document.querySelector('.movie-poster-container img');
...
window.onload = () => {
    let url = 'https://api.themoviedb.org/3/movie/533535?api_key=4ca94f8b470d7e34bd3f59c3914295c8';
    ...
    .then(data => {
        ...
        movivePoster.src = posterUrl;
        movivePoster.alt = `${data.title} Poster`;
